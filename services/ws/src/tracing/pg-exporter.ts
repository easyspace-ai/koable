...
// spans into the doable Postgres instance. Mirrors services/api/src/tracing/
// pg-exporter.ts — kept as a copy because services/ws is a separate package
// and cross-package source imports between services aren't conventional.
...
export class PostgresSpanExporter implements SpanExporter {
  ...
  async forceFlush(): Promise<void> {
    /* BatchSpanProcessor handles flushing */
  }
}
