...
export function DangerTab({
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      addToast("success", t("workspace.danger.deletedSuccess"));
      setTimeout(() => {
      ...
      addToast(
        ...
        err instanceof Error
          ? err.message
          : t("workspace.danger.deleteFailed")
      );
      setDeleting(false);
    }
  };
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <h2 className="text-lg font-semibold">
              {t("workspace.danger.transferTitle")}
            </h2>
            <p className="mt-1 text-sm text-muted-foreground">
              {t("workspace.danger.transferDescription")}
            </p>
            <div className="mt-4 space-y-3">
              <div className="space-y-2">
                ...
                >
                  {t("workspace.danger.newOwnerEmail")}
                </label>
                <input
                  id="transfer-email"
                  type="email"
              ...
              <button
                ...
                onClick={() =>
                  addToast(
                    "success",
                    t("workspace.danger.transferSent")
                  )
                }
              ...
              >
                ...
                {t("workspace.danger.transferOwnership")}
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <h2 className="text-lg font-semibold text-destructive">
              {t("workspace.danger.deleteTitle")}
            </h2>
            <p className="mt-1 text-sm text-muted-foreground">
              {t("workspace.danger.deleteDescription")}
            </p>
            ...
            {!showDeleteDialog ? (
              ...
              >
                ...
                {t("workspace.danger.deleteButton")}
              </button>
            ) : (
              <div className="mt-4 rounded-lg border border-destructive/20 bg-destructive/5 p-4">
                <p className="text-sm font-medium text-destructive">
                  {t("workspace.danger.confirmTitle")}
                </p>
                <p className="mt-1 text-sm text-muted-foreground">
                  {t("workspace.danger.confirmHint", { name: workspace.name })}
                </p>
                ...
                <div className="mt-3 space-y-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      ...
                      {deleting
                        ? t("workspace.danger.deleting")
                        : t("workspace.danger.confirmDelete")}
                    </button>
                    <button
                      onClick={() => {
